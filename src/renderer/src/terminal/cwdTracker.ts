 ...
 *   2. the command the user typed, matched against the `cd` family — the
 *      fallback that works with no shell cooperation at all.
 *
 ...
 * one. An empty string means "bare cd" (the shell's home directory).
 */
